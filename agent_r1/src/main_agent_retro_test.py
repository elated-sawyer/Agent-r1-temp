...
"""
from .agent_ray_trainer_retro_test import RayAgentTrainer
...
def main_task(config):
    ...
    from .agent_ray_trainer_retro_test import ResourcePoolManager, Role
    ...
    trainer = RayAgentTrainer(config=config,
                            ...
                            val_reward_fn=RewardManager(tokenizer=tokenizer, num_examine=200),
                            env=env)
