...
"""
from .agent_ray_trainer_retro import RayAgentTrainer
...
class RewardManager():
    ...
    def __call__(self, data: DataProto, env: 'ToolEnvRetro'):
        ...
        for i in range(len(data)):
            ...
            score, end_score, answer_score, format_score = _default_compute_all_score_back(data_source=data_source, solution_str=sequences_str, ground_truth=ground_truth, env=env_item)
...
def main_task(config):
    ...
    from .agent_ray_trainer_retro import ResourcePoolManager, Role
    ...
    env = ToolEnvRetro(tools=tools, max_turns=config.tool.max_turns,  maxstep=config.tool.maxstep, topk=config.tool.topk, shuffle=config.tool.shuffle) # TODO
