...
"""
from .agent_ray_trainer_retro_noback_new import RayAgentTrainer
...
def main_task(config):
    ...
    if config.actor_rollout_ref.actor.strategy == 'fsdp':
        ...
        from .fsdp_workers_new import ActorRolloutRefWorker, CriticWorker
    ...
    from .agent_ray_trainer_retro_noback_new import ResourcePoolManager, Role
    ...
    env = ToolEnvRetroNoBack(tools=tools, max_turns=config.tool.max_turns,  maxstep=config.tool.maxstep, topk=config.tool.topk, shuffle=config.tool.shuffle, force_noloop=config.tool.force_noloop) # TODO
